...
{
    public class GSpriteSheetAnimationData
    {
        public IReadOnlyList<GSpriteSheetAnimationStateData> States { get; }

        public GSpriteSheetAnimationData(IReadOnlyList<GSpriteSheetAnimationStateData> states)
        {
            States = states;
        }
        ...
        public static GSpriteSheetAnimationData ReadFrom(Stream stream)
        {
